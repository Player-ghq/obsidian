...
9. 回答应尽量带上书名与页码范围，例如“依据《骨骼肌肉功能解剖学 第2版》p.120-126”或“依据北体《运动解剖学》p.30-66”。
10. 若清洗层文字明显错漏，再回到原始 `chunks/by-book/` 或 `extracted/` 查页级文本；只有页级文本也不足时，才提示需要重新查看 PDF 图像页。
11. 面向考研答题时，优先把知识转写为“概念-结构-功能-运动/康复意义-易混点”的格式。
