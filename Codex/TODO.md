...
- [ ] Anki 图片遮挡插件：按 `/Users/HaoQi/Documents/Codex/anki_modules/docs/superpowers/specs/2026-08-04-ioe-style-single-card-sequential-reveal-design.md` 实现一卡多遮挡版本；完成后在 Anki 26.05 验证 IOE 风格画布、Done 回写当前笔记、原生 Add 只生成一张卡、按序揭示、无频闪 hover、背面全部显示和旧卡兼容。
