...
- [ ] 电子科技大学830备考：核对2027年招生专业目录与830正式考纲；有可靠来源时补2024–2026真题（现文件缺2017，2024只有占位）。三套原创模拟卷及独立评分已于2026-09-19完成；收到首周摸底或模拟卷答卷后，按分步评分、错因与用时调整每日3小时计划，入口 `projects/电子科技大学830数字图像处理备考/README.md`。
