...
- [ ] Anki 图片遮挡插件：按计划 `/Users/HaoQi/Documents/Codex/anki_modules/docs/superpowers/plans/2026-08-04-configurable-shortcuts-reeditable-masks.md` 实现 JSON 可配置快捷键、新 Mask 完成后立即拖动、schema-2 已有笔记只编辑 Mask，以及默认锁定的 `Enable mask editing`；完成后重新打包并在真实 Anki 26.05 profile 验收。
