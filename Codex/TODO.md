...
- [ ] Anki 图片遮挡插件：一卡多遮挡版本已实现并通过 58 项自动测试；在真实 Anki 26.05 profile 安装 `/Users/HaoQi/Documents/Codex/anki_modules/universal_image_occlusion/dist/universal_image_occlusion.ankiaddon`，手工验收按钮作用域、Done 回写、原生 Add 单卡、按序揭示、无频闪 hover、背面全显和旧卡兼容。
